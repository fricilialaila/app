<?php
    ...
    $setkelas = mysqli_query($conn,"select a.nama_siswa, b.nama_kelas, c.tahun from tblsiswa a, tblkelas b, tbsetkelas c where a.id=c.idsiswa AND b.idkelas=c.idkelas order by b.nama_kelas, a.nama_siswa asc");
?>
